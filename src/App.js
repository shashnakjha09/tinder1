  ...
  return (<Router>
      ...
      <div className="App">
            ...
            <div>
                  ...
                  <IconButton>
                  <Link to="/profile-info"><PersonIcon fontSize="large" className="header-icon" /></Link>
                  </IconButton>

                  <Link to="/"><img 
                  className="header-logo" fontSize="large" src="https://1000logos.net/wp-content/uploads/2018/07/Tinder-logo.jpg"
                  alt=""
                  /> </Link>
                  <IconButton>
