    ...
    <div>
          ...
          <h3 className="info-name">
            ...
            <IconButton>
              <CheckCircleOutlineOutlinedIcon
                fontSize="large"
                className="text-success info-icon"
              />
            </IconButton>
          </h3>
        </Container>
      ...
      <Container>
        ...
        <h6 className="footer-text">
          you get 5 liks par day and can increase your chance to match by 3
          times
        </h6>
      </Container>
      ...
      <Container>
        <div className="footer-button">
          <IconButton>
            <h6 className="footer-button-text">MY TINDER PLUSE</h6>
          </IconButton>
        </div>
      </Container>
    </div>
